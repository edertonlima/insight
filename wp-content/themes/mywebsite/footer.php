...
<section id="theme-panel" class="close-theme-panel">
	<!--Panel Button -->
	<a class="panel-button dark" id="panel-button"><i class="fa fa fa-cog fa-spin"></i></a>
	<div class="segment">
		<h4 class="dark condensed semibold uppercase no-margin no-padding">Color Switcher</h4>
	</div>
	<!-- Colors -->
	<div class="segment"> <a title="orange" class="switcher orange-bg"></a> <a title="blue" class="switcher blue-bg"></a> <a title="green" class="switcher green-bg"></a> <a title="red" class="switcher red-bg"></a> <a title="l-blue" class="switcher l-blue-bg"></a> <a title="yellow" class="switcher yellow-bg"></a> <a title="l-green" class="switcher l-green-bg"></a> <a title="sandal" class="switcher sandal-bg"></a> </div>
</section>
<!-- End Color Switcher -->
<!-- Script Begins -->
