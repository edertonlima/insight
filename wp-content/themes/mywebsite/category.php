				...
				<div class="col-md-12 static">
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-2">
						<ul class="nav navbar-nav navbar-right ">
							...
							<li class="active"><a href="<?php echo get_home_url(); ?>/page/blog" class="scroll">Blog</a></li>
...
<?php /* BLOG */ ?>
<section id="blog" class="blog-section section slant-angle parallax1bg">
	<!-- Slant Shape -->
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-xs-12">
				<!-- Title -->
				<h2 class="section-title text-center  animated fadeInRight visible" data-animation="fadeInRight" data-animation-delay="500">Blog</h2>
				<!-- Sub Title -->
				<p class="sub-title text-center animated fadeInLeft visible" data-animation="fadeInLeft" data-animation-delay="500">​Fique de olho em nossos artigos, matérias e novidades relacionadas ao universo da saúde ocular.</p>
			</div>
		</div>
	</div>	
		<!-- blog -->
	<div class="container list-blog">
		<div class="row">
			<div class="col-xs-12 animated" data-animation="fadeInUp" data-animation-delay="500">
				...
				<div id="" class="blog-carousel-slider">
					...
					<?php if ( have_posts() ) : ?>
						<?php while ( have_posts() ) : the_post(); ?>
						    ...
						    if($capa[0]){ ?>
								...
								<div class="blog-item" style="margin: 0 0 20px 0; width: 33.333% !important; float: left; padding: 10px;">
									<!-- Img -->
									<div class="blog-pic">
...
<section class="blog-section section blog-post">

	<div class="col-md-12 animated fadeInUp visible" data-animation="fadeInUp" data-animation-delay="500">
		<?php paginacao(); ?>
	</div>
